// -----------------------------------------------------------------------------
// 3D-Model (OpenSCAD) of the hinges.
//
// This file only modifies settings (parameters) of the original program
// and therefore includes <dimensions.scad>.
//
// Original available from: https://www.thingiverse.com/thing:2187167
// License: Creative Commons Attribution
//
// Author: Bernhard Bablok (minor modifications)
//
...
counter_sink_depth               = 0;
fastener_thread_diameter         = 0;
...
fastener_count                   = 0;   // [3:32]
fastener_column_count            = 0;   // [1,2]
